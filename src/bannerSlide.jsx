    ...
    <div className="banner_container">
      <ul className="banner_slide" style={{ transform: `translateX(-${slidePosition}%)` }}>
        <li className="slide">
          ...
          <button className={`button_slide_link${slidePosition === 0 ? active : ''}`}>
            Подробнее
          </button>
        </li>
        <li className="slide">
          <img className="slide_img" src={slide2} />
          <img src={chandelier1} className={`chandelier${slidePosition === 100 ? active : ''}`} />
          <p className={`title_slide${slidePosition === 100 ? active : ''}`}>Line by Maytoni</p>
          <p className={`description_slide${slidePosition === 100 ? active : ''}`}>
            Встречайте эффектную новинку в коллекции Maytoni Technical
          </p>
          <button className={`button_slide_standart${slidePosition === 100 ? active : ''}`}>
            Подробнее
          </button>
        </li>
        <li className="slide">
          <img className="slide_img" src={slide3} />
          <p className={`title_slide${slidePosition === 200 ? active : ''}`}>Line by Maytoni</p>
          <p className={`description_slide${slidePosition === 200 ? active : ''}`}>
            Встречайте эффектную новинку в коллекции Maytoni Technical
          </p>
          <button className={`button_slide_standart${slidePosition === 200 ? active : ''}`}>
            Подробнее
          </button>
        </li>
        <li className="slide">
          <img className="slide_img" src={slide4} />
          <img src={chandelier2} className={`chandelier${slidePosition === 300 ? active : ''}`} />
          <p className={`title_slide${slidePosition === 300 ? active : ''}`}>Line by Maytoni</p>
          <p className={`description_slide${slidePosition === 300 ? active : ''}`}>
            Встречайте эффектную новинку в коллекции Maytoni Technical
          </p>
          <button className={`button_slide_standart${slidePosition === 300 ? active : ''}`}>
            Подробнее
          </button>
        </li>
        <li className="slide">
          <img className="slide_img" src={slide5} />
          <p className={`title_slide${slidePosition === 400 ? active : ''}`}>Line by Maytoni</p>
          <p className={`description_slide${slidePosition === 400 ? active : ''}`}>
            Встречайте эффектную новинку в коллекции Maytoni Technical
          </p>
          <button className={`button_slide_standart${slidePosition === 400 ? active : ''}`}>
            Подробнее
          </button>
        </li>
      </ul>
